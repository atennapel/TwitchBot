...
function TwitchBot(o) {
	...
	this._userDataAutosave = o.userDataSaveToFile || false;
...
TwitchBot.prototype.getUserData = function(name) {
	return this.userData[checkUser(name)];
};

TwitchBot.prototype.getProperty = function(name, prop) {
	return this.userData[checkUser(name)][prop];
};

TwitchBot.prototype.setProperty = function(name, prop, v) {
	var name = checkUser(name);
	return this.userData[name][prop] = typeof v == 'function'? v(this.userData[name][prop]): v;
};

TwitchBot.prototype.setProperties = function(name, o) {
	for(var k in o)
		this.setProperty(name, k, o[k]);
	return this;
};
