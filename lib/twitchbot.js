...
TwitchBot.prototype.run = function() {
	...
	process.on('SIGINT', (function() {this.autosave(); for(var i = 0, l = this._onexit.length; i < l; i++) this._onexit[i].call(this, this); process.exit()}).bind(this));
...
TwitchBot.prototype.addOnExitEvent = function(f) {this._onexit.push(f); return this};
